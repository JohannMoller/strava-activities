...
import { registerMap, registerTheme } from 'echarts';
...
class EChart extends React.Component {
  constructor(props) {
    ...
    if (props.properties.map) {
      registerMap(
        props.properties.map.mapName,
        props.properties.map.geoJSON,
        props.properties.map?.specialAreas
      );
    }
  }
